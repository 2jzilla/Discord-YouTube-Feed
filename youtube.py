...
channel_ids = {'LegoHamburger': 'UCukmNq2pLxb4tAmxVykDa9g'}  
...
async def create_webhook(title, link, youtube_name, date):
    async with aiohttp.ClientSession() as session:
        ...
        discord_webhook_url = https://discord.com/api/webhooks/1443260799253479609/kI2FrRM1PYnC_V6MlhafEz4vwOXFyqUlxAJl9jdbKSrn_1xmpKpttcLmO43If0dHv7w3
        ...
        webhook_username = Announcer # enter name of the Webhook user, can be anything (in this case, it's YouTube Bot)
